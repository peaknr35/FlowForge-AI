    ...
    <div className="min-h-screen bg-zinc-950 text-white p-8 max-w-4xl mx-auto">
      ...
      <section className="mb-12">
        ...
        <div className="space-y-2 text-zinc-300 text-sm">
          ...
          <p>Client ID: <code className="bg-zinc-800 px-2 py-0.5 rounded">{googleClientId}</code></p>
          <p>Redirect URI: <code className="bg-zinc-800 px-2 py-0.5 rounded">{callbackUrl}</code></p>
        </div>
      </section>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-4 text-zinc-300">
          ...
          <p className="text-sm"><strong className="text-white">Webhook URL:</strong> <code className="bg-zinc-800 px-2 py-0.5 rounded block mt-1">{webhookUrl}</code></p>
          ...
          <ol className="ml-4 space-y-2 text-sm">
            <li>Run: <code className="bg-zinc-800 px-2 py-0.5 rounded block mt-1">stripe listen --forward-to http://localhost:3000/api/stripe/webhook</code></li>
      ...
      <section className="mb-12">
        ...
        <ol className="space-y-2 text-zinc-300 text-sm">
          <li>Start dev server: <code className="bg-zinc-800 px-2 py-0.5 rounded">npm run dev</code></li>
